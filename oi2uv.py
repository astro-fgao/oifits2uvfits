...
parser.add_argument('--specavg', dest='specavg', type=int, default=-1 ,help='whether to do spectral averaging (default: False)')
...
obs = vb.load_obs_oifits(args.input, rescale_flux=args.rescale_flux, renorm_flux=args.renorm_flux, renorm_num=args.renorm_num, airmass=args.airmass, visdata=args.visdata, specavg=args.specavg)
